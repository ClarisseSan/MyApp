...
/**
 * An activity representing a single Poster detail screen. This
 * activity is only used narrow width devices. On tablet-size devices,
 * item details are presented side-by-side with a list of items
 * in a {@link PosterListActivity}.
 */
public class PosterDetailActivity extends Activity {
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        if (id == android.R.id.home) {
            ...
            //
            NavUtils.navigateUpTo(this, new Intent(this, PosterListActivity.class));
            return true;
        }
